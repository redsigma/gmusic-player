...
BASE.SetDisabled = function(self, bool)
    print("[Base] disabled:", bool)
end
...
BASE.SetHeight = function(self)  self.h = val end
BASE.SetWidth = function(self)  self.w = val end
BASE.GetText = function(self) return self.text end
BASE.SetText = function(self, text) self.text = text end
BASE.GetTall = function(self) return 0 end
BASE.SetTall = function(self, val) self.h = val end
BASE.GetWide = function(self) return 0 end
BASE.SetWide = function(self)  self.w = val end
...
MSLIDER = {}
MSLIDER.Init = function(self) self.Knob = MBUTTON end
MSLIDER.SetLockY = function(self) end
MSLIDER.SetNotches = function(self, num_notches) end
MSLIDER.SetSlideX = function(self) end
MSLIDER.SetSlideY = function(self) end
...
MNUMSCRATCH.SetDecimals = function(self) end
MNUMSCRATCH.SetValue = function(self, val) self.value = val end
MNUMSCRATCH.SetMin = function(self) end
MNUMSCRATCH.GetMin = function(self) return 0 end
MNUMSCRATCH.SetMax = function(self, num) self.slider_max = num end
MNUMSCRATCH.GetMax = function(self) return self.slider_max end
...
MTEXTENTRY.SetValue = function(self, num) self.val = num end
