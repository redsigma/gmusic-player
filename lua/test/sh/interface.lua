...
local it = 0
local assert = 0
_G.set_shared_interface = function(_insulate, _describe, _it, _assert)
  insulate = _insulate
  describe = _describe
  it = _it
  assert = _assert
...
function sh_play(dermaBase, channel)
  describe("play", function()
    ...
    it("song list highlight line", function()
      assert.line_highlight(0, channel, song_line, 0)
    end)
  end)
end
-------------------------------------------------------------------------------
function sh_play_play_different(dermaBase, channel)
  describe("play", function()
    ...
    describe("play another", function()
      ...
      it("update derma ui", function()
        assert.ui_top_bar_color(0, "Example1")
        assert.same(dermaBase.contextmedia:IsMissing(), false)
      end)
      it("song list highlight line", function()
        assert.line_highlight(0, channel, song_line, 2)
      end)
    end)
  end)
end
  ...
  describe("play", function()
    ...
    describe("autoplay", function()
      ...
      describe("play", function()
        ...
        it("song list highlight line", function()
          assert.line_highlight(1, channel, song_line, 2)
        end)
      end)
    end)
  end)
...
-------------------------------------------------------------------------------
function sh_play_pause(dermaBase, channel)
  local song_line = 2
  describe("play", function()
    dermaBase.buttonplay:DoClick(nil, song_line)
    describe("pause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight(2, channel, song_line, 0)
      end)
    end)
  end)
end
-------------------------------------------------------------------------------
function sh_pause_unpause(dermaBase, channel)
...
function sh_play_loop_pause_unpause(dermaBase, channel)
  describe("play & loop & pause", function()
    ...
    describe("unpause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight(3, channel, song_line, 0)
      end)
    end)
  end)
end
...
function sh_play_autoplay_pause_unpause(dermaBase, channel)
  describe("play & autoplay & pause", function()
    ...
    describe("unpause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight(1, channel, song_line, 0)
      end)
    end)
  end)
end
  ...
  describe("play", function()
    ...
    describe("stop", function()
      ...
      it("reset ui", function()
        assert.same(channel.title_song, 0)
