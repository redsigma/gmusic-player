...
function sh_play(dermaBase, channel)
  describe("play", function()
    ...
    it("song list highlight line", function()
      assert.line_highlight_play(song_line, 0, channel)
    end)
  end)
end
...
function sh_play_play_different(dermaBase, channel)
  describe("play", function()
    ...
    describe("play another", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_play(song_line, 2, channel)
      end)
    end)
  end)
end
...
-------------------------------------------------------------------------------
function sh_pause_play_different(dermaBase, channel)
  describe("play", function()
    local first_song_line = 1
    local next_song_line = 2
    channel.song_index = 0
    dermaBase.buttonplay:DoClick(nil, first_song_line)
    dermaBase.buttonpause:DoClick()

    describe("play another", function()
      it("is playing", function()
        dermaBase.buttonplay:DoClick(nil, next_song_line)
        assert.is_false(channel.isPaused)
        assert.is_true(channel.isPlaying)
        assert.is_false(channel.isStopped)
        assert.is_false(channel.isLooped)
      ...
      it("song list highlight line", function()
        assert.line_highlight_play(next_song_line, first_song_line, channel)
      end)
    end)
  end)
end
  ...
  describe("play", function()
    ...
    describe("autoplay", function()
      ...
      describe("play", function()
        ...
        it("song list highlight line", function()
          assert.line_highlight_autoplay(song_line, prev_line, channel)
        end)
      end)
    end)
  end)
  ...
  describe("play", function()
    ...
    describe("autoplay", function()
      ...
      describe("play", function()
        ...
        it("song list highlight line", function()
          assert.line_highlight_play(song_line, prev_line, channel)
        end)
      end)
    end)
  end)
  ...
  describe("play", function()
    ...
    describe("autoplay", function()
      ...
      describe("play", function()
        ...
        it("song list highlight line", function()
          assert.line_highlight_play(1, prev_line, channel)
        end)
      end)
    end)
  end)
...
function sh_play_pause(dermaBase, channel, more_checks)
  ...
  describe("play", function()
    ...
    describe("pause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_pause(song_line, 0, channel)
      end)
...
function sh_play_live_seek_pause(dermaBase, channel)
  ...
  describe("live seek", function()
    ...
    describe("pause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_autoplay_paused(1, 0, channel)
      end)
    end)
  end)
end
...
function sh_play_live_seek_pause_unpause(dermaBase, channel)
  describe("play & pause live", function()
    ...
    describe("unpause live", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_play(1, 0, channel)
      end)
    end)
  end)
end
...
function sh_play_loop_pause_unpause(dermaBase, channel)
  describe("play & loop & pause", function()
    ...
    describe("unpause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_loop(song_line, 0, channel)
      end)
    end)
  end)
end
...
function sh_play_live_seek_loop_pause_unpause(dermaBase, channel)
  describe("live seek & loop & pause", function()
    ...
    describe("unpause live seek", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_loop(1, 0, channel)
      end)
    end)
  end)
end
...
function sh_play_autoplay_pause_unpause(dermaBase, channel)
  describe("play & autoplay & pause", function()
    ...
    describe("unpause", function()
      ...
      it("song list highlight line", function()
        assert.line_highlight_autoplay(song_line, 0, channel)
      end)
    end)
  end)
end
  ...
  describe("play", function()
    ...
    describe("stop", function()
      ...
      it("song list dont highlight line", function()
        assert.line_highlight_stop(0, song_line, channel)
      end)
    end)
  end)
end
