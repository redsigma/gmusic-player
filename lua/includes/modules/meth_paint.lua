...
local function theme_dark(self, enable_dark_mode)
...
local function paintSlider(self, panel)
	...
	panel.Slider.Paint(
        panel.Slider, panel.Slider:GetWide(), panel.Slider:GetTall())
end
